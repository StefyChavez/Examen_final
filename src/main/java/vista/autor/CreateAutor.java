...
import controlador.AutorControl;
 ...
 * @author admin
 */
public class CreateAutor extends javax.swing.JInternalFrame {
    ...
    private void actualizarTable1(){
        ...
        var datos = new Object[this.autorControl.listar().size()][2];
        
        var i=0;
        for(var autor:this.autorControl.listar())
        {
            datos[i][0]=autor.getCodigo();
